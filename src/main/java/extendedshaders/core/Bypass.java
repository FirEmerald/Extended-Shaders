	...
	*/
	...
	public static void bindTexture(TextureManager manager, ResourceLocation tex)
	{
		if (ShaderRegistry.shadersActive)
		{
	    	...
	    	{
	    		GLSLHelper.uniform1i(Main.isAlias, 1);
	    		isAlias = true;
	    	}
	...
	public static void glFog(int pname, FloatBuffer param)
	{
		...
		if (ShaderRegistry.shadersActive)
		{
			if (pname == GL11.GL_FOG_COLOR) GLSLHelper.uniform4f(Main.fogColor, fogColor[0] = param.get(0), fogColor[1] = param.get(1), fogColor[2] = param.get(2), fogColor[3] = param.get(3));
		}
	}
